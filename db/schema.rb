...
ActiveRecord::Schema.define(version: 20170130212155) do
  ...
  create_table "portfolios", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.string   "url_access"
    t.string   "birth_date"
    t.index ["language_id"], name: "index_portfolios_on_language_id", using: :btree
  end
  ...
  add_foreign_key "portfolios", "languages"
end
